...
def get_data_loaders(
    ...
    "train": transforms.Compose([
        ...
        transforms.RandomAffine(degrees=(-25,10),translate=(0.15,0.15),scale=(0.6,1.4),shear=(-15,15)),
        ...
        "valid": transforms.Compose([
            transforms.Resize(256),transforms.CenterCrop(224),transforms.ToTensor(),transforms.Normalize(mean=mean,std=std)]
            # YOUR CODE HERE
        ),
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    # Display the figure and then close it
    plt.show()
    plt.close(fig)
